...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //getVideoTime(filePath, ffmpegPath);
        //VideoFolderDuration videoFolderDuration = new VideoFolderDuration();
        //videoFolderDuration.getVideoDuration(fileFolderPath,1);
        //videoFolderDuration.accountAllTime();
        ...
        //videoFolderTimeCount.accountAllTime();
    }
}
